//This needs to deleted. Not a valid class
...
public class Resources_GetAppointments
{
	public static Boolean Resources_GetAppointments_Test(String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
