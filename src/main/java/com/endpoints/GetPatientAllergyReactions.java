...
public class GetPatientAllergyReactions 
{

	public static Boolean getPatientAllergyReactions_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
