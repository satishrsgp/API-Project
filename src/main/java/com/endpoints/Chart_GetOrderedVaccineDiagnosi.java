...
public class Chart_GetOrderedVaccineDiagnosi
{
	...
	public static Boolean Chart_GetOrderedVaccineDiagnosi_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
		...
		if(!strResponse.isEmpty() && !strResponse.contains("is not valid for Guid"))
		{
			...
			{ 
				String strQuery = "select  lod.unique_diag_num AS id, "
						...
						+ " WHERE (ino.person_id = '"+parameters.get("personId")+"' and (iov.order_vaccine_id = '"+parameters.get("vaccineId")+"') and (ino.order_num = '"+parameters.get("orderId")+"') )";
