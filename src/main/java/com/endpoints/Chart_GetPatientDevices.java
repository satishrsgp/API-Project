...
/*
 * ********************************************************************
 * Class Name						: Chart_GetPatientDevices
...
public class Chart_GetPatientDevices
{
	public static Boolean chart_GetPatientDevices_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
		...
		if(!strResponse.isEmpty() && !strResponse.contains("is not valid for Guid"))
		{
			String strQuery = "SELECT pid.implantable_device_id AS id, pid.person_id AS personId, pid.device_identifier AS deviceIdentifier, "
					...
					+ "WHERE pid.person_id = '"+parameters.get("personId")+"' ";

			String[] jsonMetaData = {"id","personId","deviceIdentifier","universalDeviceIdentifier","snoMedCtCode","snoMedCtDescription","lotOrBatchNumber","serialNumber","manufacturingDate", 
					"expirationDate","isDeleted", "assigningAuthorityOid", "assigningAuthority"};
