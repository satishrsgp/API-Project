...
public class Resources_GetResourceAppointId
{

	/*
	 * ********************************************************************************
	 * Class Name						:Resources_GetResourceApptStatHi
	 * Created By						: 
	 * Created Date						: 
	 * Modified Date					:
	 * Modified By						:
	...
	public static Boolean resources_GetResourceAppointId_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
		...
		if(!strResponse.isEmpty() && !strResponse.contains("is not valid for Guid"))
		{
			...
			{ 
				String strQuery = "select "
						...
						+" where am.resource_id='" +parameters.get("resourceId")+"' and a.appt_id='"+parameters.get("appointmentId")+"'order by a.appt_date desc,a.begintime asc,a.appt_id asc";
