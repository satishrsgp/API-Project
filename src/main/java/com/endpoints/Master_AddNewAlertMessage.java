...
public class Master_AddNewAlertMessage 
{
	public static Boolean Master_AddNewAlertMessage_Test(String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
