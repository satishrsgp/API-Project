...
public class Chart_GetPatientAlerts 
{

	public static Boolean chart_GetPatientAlerts_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
		...
		if(!strResponse.isEmpty() && !strResponse.contains("is not valid for Guid"))
		{
			try
			{
				String strQuery = "SELECT pae.alert_id AS id, pae.person_id AS personId, pae.message_id AS messageId, pae.source_type AS alertTypeId, "
						...
						+ "LEFT JOIN patient_alerts_ehr_audit ea on ea.alert_id = pae.alert_id where pae.person_id = '"
