...
public class GetPatientAllergySummaries
{
	public static Boolean getPatientAllergySummaries_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
