...
public class Chart_GetPatientRecallPlan 
{

	public static Boolean chart_GetPatientRecallPlan_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
		...
		if(!strResponse.isEmpty() && !strResponse.contains("is not valid for Guid"))
		{
			try
			{
				String strQuery = "select prp.person_id as personId, prp.practice_id as practiceId, prp.recall_plan_id as recallPlanId, "
						...
						+ "prp.last_date as lastDate, prp.plan_end_date as approximateLastDate, prp.expected_return_date as expectedReturnDate, "
						...
						+ "prp.modified_by as modifiedByUserId, concat(um.last_name,', ',um.first_name,' ', um.mi) as modifiedByName, "
				...
				String[] jsonMetaData = {"personId","practiceId","recallPlanId","id","description","isActive","note","startDate","endDate",
						"lastDate","approximateLastDate","expectedReturnDate","letter1ScheduledDate","letter1SentDate","letter2ScheduledDate",
				"letter2SentDate","letter3ScheduledDate","letter3SentDate",	"stopReasonId",	"stopReason","eventId","eventDescription","resourceId",
				"resourceDescription","locationId","locationName","createdByUserId","createdByName","createTimestamp;Date_YYYYMMDD HH:MM:SS","modifiedByUserId","modifiedByName","modifyTimestamp;Date_YYYYMMDD HH:MM:SS"
				};
				try
				{	
