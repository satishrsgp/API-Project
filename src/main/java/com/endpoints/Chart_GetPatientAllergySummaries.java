...
public class Chart_GetPatientAllergySummaries
{
	public static Boolean chart_GetPatientAllergySummaries_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
		...
		if(!strResponse.isEmpty() && !strResponse.contains("is not valid for Guid"))
		{
			try
			{
				String strQuery = "SELECT pa.uniq_id as id, pa.enterprise_id as enterpriseId, pa.practice_id as practiceId, "
						...
						+ "WHERE pa.person_id = '"+parameters.get("personId") +" ' and pa.enc_id = '"+ parameters.get("encounterId") +"' "+" ORDER BY pa.rxn_desc DESC";
				...
				String[] jsonMetaData = {"id","enterpriseId","practiceId","personId","encounterId","encounterTimestamp;Date_YYYYMMDD HH:MM:SS","encounterTimestampTimezone","allergyId","allergyTypeId","description","allergyType","locationId",
						"providerId","onsetDate","resolvedDate","comment","reactionDescription","isLocked","isReadOnly"};
