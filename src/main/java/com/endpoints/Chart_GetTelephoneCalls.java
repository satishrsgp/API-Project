...
public class Chart_GetTelephoneCalls 
{
	public static Boolean chart_GetTelephoneCalls_Test(HashMap<String, String> parameters, String strResponse, String strUniqueJsonToken, SoftAssert softAssert)
	{
		...
		if(!strResponse.isEmpty() && !strResponse.contains("is not valid for Guid"))
		{
			try
			{
				...
				String strQuery = "SELECT tc.enc_id as encounterId, tc.person_id AS personId, tc.taken_by AS takenBy, tc.call_details AS call_details FROM telephone_call_ tc "
						+ " where person_id = '"+parameters.get("personId")+"'";

						
				
				String[] jsonMetaData = {"encounterId","personId","takenBy","callDetails"};
