...
import com.endpoints.Audit_GetSecurityDetail;
...
public class Audit_GetSecurityDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void audit_GetSecurityDetail_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Audit_GetSecurityDetail.Audit_GetSecurityDetail_Test(parameters, strResponse, "id", softAssert);
				}
				else
