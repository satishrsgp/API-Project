...
import com.endpoints.Chart_AddPatientRecallPlan;
...
public class Chart_AddPatientRecallPlan_TC1 extends BaseTest
{
    ...
    @Test
    public void chart_AddPatientRecallPlan_TC1()
    {
                    ...
                    try
                    {
                                    ...
                                    for(int k=1; k<=ExcelReaderWriter.getRowCount( BaseTest.mapExecutionConfigs.get("TestDataWorkBook"), strTestDataSheetName); k++)
                                    {
                                                    ...
                                                    String strCountQuery = "select * from patient_recall_plans WHERE person_id = '"+parameters.get("personId")+"' order by create_timestamp desc";
                                                    ...
                                                    if(Objects.equals(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass") && objHandler.getIntResponseCode() == 201)
                                                    {
                                                                    ...
                                                                    boolTestDataStatus = Chart_AddPatientRecallPlan.chart_AddPatientRecallPlan_Test(parameters, strResponse, mapPostDetails, softAssert, strCountQuery);
                                                    }
