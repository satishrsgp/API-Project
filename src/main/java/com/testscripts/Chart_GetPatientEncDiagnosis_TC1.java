...
import com.endpoints.Chart_GetPatientEncDiagnosis;
...
public class Chart_GetPatientEncDiagnosis_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetPatientEncDiagnosis_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPatientEncDiagnosis.chart_GetPatientEncDiagnosis_Test(parameters, strResponse, "id", softAssert);
				}
				else
