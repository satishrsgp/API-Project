...
import com.endpoints.Provider_GetProviderDetails;
...
public class Provider_GetProviderDetails_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void provider_GetProviderDetails_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Provider_GetProviderDetails.provider_GetProviderDetails(parameters, strResponse, "id", softAssert);
					}
				}
