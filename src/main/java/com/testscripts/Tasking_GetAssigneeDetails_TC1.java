...
import com.endpoints.Tasking_GetAssigneeDetails;
...
public class Tasking_GetAssigneeDetails_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void tasking_GetAssigneeDetails_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Tasking_GetAssigneeDetails.tasking_GetAssigneeDetails(parameters, strResponse, "taskId", softAssert);
					}
				}
