...
import com.endpoints.Chart_GetPatientAlerts;
...
public class Chart_GetPatientAlerts_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetPatientAlerts_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPatientAlerts.chart_GetPatientAlerts_Test(parameters, strResponse, "id", softAssert);
				}
				else
