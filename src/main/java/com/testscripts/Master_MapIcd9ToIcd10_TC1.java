...
import com.endpoints.Master_MapIcd9ToIcd10;
...
public class Master_MapIcd9ToIcd10_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_MapIcd9ToIcd10_TC1()
	{
		...
		try
		{
			...
			for(int k=1; k<=ExcelReaderWriter.getRowCount( BaseTest.mapExecutionConfigs.get("TestDataWorkBook"), strTestDataSheetName); k++)
			{
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_MapIcd9ToIcd10.master_MapIcd9ToIcd10_Test(parameters, strResponse, "icdCode", softAssert);
				}
				else
				{
