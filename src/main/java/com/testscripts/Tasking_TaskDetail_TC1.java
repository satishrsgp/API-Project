...
import com.endpoints.Tasking_TaskDetail;
...
public class Tasking_TaskDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void tasking_TaskDetail_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Tasking_TaskDetail.tasking_TaskDetail_Test(parameters, strResponse, "id", softAssert);
				}
				else
