...
import com.endpoints.Task_GetTasks;
...
public class Task_GetTasks_TC1 extends BaseTest
{
	SoftAssert softAssert = new SoftAssert();

	@Test
	public void tasking_Tasking_GetTasks_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Task_GetTasks.Task_GetTasks_Test(parameters, strResponse, "id", softAssert);
					}
				}
