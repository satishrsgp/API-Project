...
import com.endpoints.Provider_Getpaqs;
...
public class Provider_Getpaqs_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void provider_Getpaqs_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Provider_Getpaqs.Provider_Getpaqs_Test(parameters, strResponse, "itemId", softAssert);
				}
				else
