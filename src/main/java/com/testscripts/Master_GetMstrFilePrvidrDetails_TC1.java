...
import com.endpoints.Master_GetMstrFilePrvidrDetails;
...
public class Master_GetMstrFilePrvidrDetails_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetMstrFilePrvidrDetails_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetMstrFilePrvidrDetails.master_GetMstrFilePrvidrDetails_Test(parameters, strResponse, "id", softAssert);
				}
				else
