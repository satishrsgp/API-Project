...
import com.endpoints.Master_GetExternalSystems;
...
public class Master_GetExternalSystems_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetExternalSystems_TC1()
	{
		...
		try
		{
			//Iterating through the Test DataSheet to run the testscript
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetExternalSystems.master_GetExternalSystems_Test(parameters, strResponse, "id", softAssert);
				}
				else
