...
import com.endpoints.Master_GetDiagnosisSeverities;
...
public class Master_GetDiagnosisSeverities_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_GetDiagnosisSeverities_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Master_GetDiagnosisSeverities.master_GetDiagnosisSeverities(parameters, strResponse, "id", softAssert);
					}
				}
