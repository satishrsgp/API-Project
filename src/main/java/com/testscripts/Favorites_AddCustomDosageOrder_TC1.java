...
import com.endpoints.Favorites_AddCustomDosageOrder;
...
public class Favorites_AddCustomDosageOrder_TC1 extends BaseTest
{
    ...
    @Test
    public void favorites_AddCustomDosageOrder_TC1()
    {
                    ...
                    try
                    {
                                    ...
                                    for(int k=1; k<=ExcelReaderWriter.getRowCount( BaseTest.mapExecutionConfigs.get("TestDataWorkBook"), strTestDataSheetName); k++)
                                    {
                                                    ...
                                                    String strCountQuery = "select  uniq_id,* from fdb_med_dosage_order_custom WHERE gcn_seqno = '"+parameters.get("gcnSeqNo")+"'";
                                                    ...
                                                    if(Objects.equals(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass") && objHandler.getIntResponseCode() == 201)
                                                    {
                                                                    ...
                                                                    boolTestDataStatus = Favorites_AddCustomDosageOrder.favorites_AddCustomDosageOrder_Test(parameters, strResponse, mapPostDetails, softAssert, strCountQuery);
                                                    }
