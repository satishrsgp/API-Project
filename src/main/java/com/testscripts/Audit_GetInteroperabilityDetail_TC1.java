...
import com.endpoints.Audit_GetInteroperabilityDetail;
...
public class Audit_GetInteroperabilityDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void audit_GetInteroperabilityDetail_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Audit_GetInteroperabilityDetail.audit_GetInteroperabilityDetail_Test(parameters, strResponse, "id", softAssert);
				}
				else
