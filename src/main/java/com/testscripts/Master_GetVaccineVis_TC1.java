...
import com.endpoints.Master_GetVaccineVis;
...
public class Master_GetVaccineVis_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetVaccineVis_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetVaccineVis.master_GetVaccineVis_Test(parameters, strResponse, "cvxCode", softAssert);
				}
				else
