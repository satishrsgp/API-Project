...
import com.endpoints.Users_GetPaqQuickComments;
...
public class Users_GetPaqQuickComments_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void users_GetPaqQuickComments_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Users_GetPaqQuickComments.users_GetPaqQuickComments(parameters, strResponse, "id", softAssert);
					}
				}
