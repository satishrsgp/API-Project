...
import com.endpoints.Tasking_GetTaskSets;
...
public class Tasking_GetTaskSets_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void tasking_GetTaskSets_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Tasking_GetTaskSets.tasking_GetTaskSets(parameters, strResponse, "id", softAssert);
