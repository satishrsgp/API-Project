...
import com.endpoints.Master_AlertMessages_GET;
...
public class Master_AlertMessages_GET_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_AlertMessages_GET_TC1()
	{
		...
		try
		{
			...
			if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
			{
				...
				boolTestDataStatus = Master_AlertMessages_GET.master_AlertMessages_GET_Test(strResponse, "id", softAssert);
			}
			else
			{
