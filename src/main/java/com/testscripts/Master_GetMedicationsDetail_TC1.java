...
import com.endpoints.Master_GetMedicationsDetail;
...
public class Master_GetMedicationsDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_GetMedicationsDetail_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Master_GetMedicationsDetail.master_GetMedicationsDetail(parameters, strResponse, "brandId", softAssert);
					}
				}
