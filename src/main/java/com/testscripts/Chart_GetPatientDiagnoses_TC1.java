...
import com.endpoints.Chart_GetPatientDiagnoses;
...
public class Chart_GetPatientDiagnoses_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetPatientDiagnoses_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPatientDiagnoses.chart_GetPatientDiagnoses_Test(parameters, strResponse, "id", softAssert);
				}
				else
