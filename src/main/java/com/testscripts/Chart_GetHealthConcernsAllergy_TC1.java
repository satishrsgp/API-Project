...
import com.endpoints.Chart_GetHealthConcernsAllergy;
...
public class Chart_GetHealthConcernsAllergy_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetHealthConcernsAllergy_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetHealthConcernsAllergy.chart_GetHealthConcernsAllergy_Test(parameters, strResponse, "personId", softAssert);
				}
				else
