...
import com.endpoints.Master_GetMasterListItems;
...
public class Master_GetMasterListItems_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetMasterListItems_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetMasterListItems.master_GetMasterListItems_Test(parameters, strResponse, "id", softAssert);
				}
				else
