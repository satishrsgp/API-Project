...
import com.endpoints.Audit_GetInterfaceHoldingTankDetail;
...
public class Audit_GetInterfaceHoldingTankDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void audit_GetInterfaceHoldingTankDetail_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Audit_GetInterfaceHoldingTankDetail.audit_GetInterfaceHoldingTankDetail_Test(parameters, strResponse, "id", softAssert);
				}
				else
