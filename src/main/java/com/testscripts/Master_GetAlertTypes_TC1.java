...
import com.endpoints.Master_GetAlertTypes;
...
public class Master_GetAlertTypes_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetAlertTypes_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetAlertTypes.master_GetAlertTypes_Test(parameters, strResponse, "id", softAssert);
				}
				else
