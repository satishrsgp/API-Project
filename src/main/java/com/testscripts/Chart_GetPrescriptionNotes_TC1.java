...
import com.endpoints.Chart_GetPrescriptionNotes;
...
public class Chart_GetPrescriptionNotes_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetPrescriptionNotes_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPrescriptionNotes.chart_GetPrescriptionNotes_Test(parameters, strResponse, "id", softAssert);
				}
				else
