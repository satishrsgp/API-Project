...
import com.endpoints.Master_GetRefillDenialReasons;
...
public class Master_GetRefillDenialReasons_TC1 extends BaseTest 
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetRefillDenialReasons_TC1()
	{
		...
		try
		{
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetRefillDenialReasons.master_GetRefillDenialReasonss_Test(parameters, strResponse, "id", softAssert);
				}
				else
