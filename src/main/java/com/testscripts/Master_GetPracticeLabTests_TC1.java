...
import com.endpoints.Master_GetPracticeLabTests;
...
public class Master_GetPracticeLabTests_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetPracticeLabTests_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetPracticeLabTests.master_GetPracticeLabTests_Test(parameters, strResponse, "id", softAssert);
				}
				else
