...
import com.endpoints.Provider_GetPaqDetail;
...
public class Provider_GetPaqDetail_TC1 extends BaseTest {


	SoftAssert softAssert = new SoftAssert();

	@Test
	public void provider_GetPaqDetail_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Provider_GetPaqDetail.Provider_GetPaqDetail_Test(parameters, strResponse, "itemId", softAssert);
					}
				}
