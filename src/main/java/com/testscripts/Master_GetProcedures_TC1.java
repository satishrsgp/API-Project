...
import com.endpoints.Master_GetProcedures;
...
public class Master_GetProcedures_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetProcedures_TC1()
	{
		...
		try
		{
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetProcedures.master_GetProcedures_Test(parameters, strResponse, "code", softAssert);
				}
				else
