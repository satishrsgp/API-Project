...
import com.endpoints.Chart_GetHlthCncrnsFamHisOrg;
...
public class Chart_GetHlthCncrnsFamHisOrg_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void chart_GetHlthCncrnsFamHisOrg_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Chart_GetHlthCncrnsFamHisOrg.chart_GetHlthCncrnsFamHisOrg(parameters, strResponse, "id", softAssert);
