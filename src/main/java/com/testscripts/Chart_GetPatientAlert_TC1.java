...
import com.endpoints.Chart_GetPatientAlert;
...
public class Chart_GetPatientAlert_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetPatientAlert_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPatientAlert.chart_GetPatientAlert_Test(parameters, strResponse, "id", softAssert);
				}
				else
