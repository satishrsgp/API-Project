...
import com.endpoints.Chart_SendOrder;
...
public class Chart_SendOrder_TC1 extends BaseTest
{
    ...
    @Test
    public void chart_SendOrder_TC1()
    {
                    ...
                    try
                    {
                                    ...
                                    for(int k=1; k<=ExcelReaderWriter.getRowCount( BaseTest.mapExecutionConfigs.get("TestDataWorkBook"), strTestDataSheetName); k++)
                                    {
                                                    ...
                                                    String strCountQuery = "select clinical_id as orderId, * from  intrf_queue "
                                							+"where person_id='"+parameters.get("personId")+"' and  "
                                							+"clinical_id = '"+parameters.get("orderId")+"' "
                                                    ...
                                                    if(Objects.equals(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass") && objHandler.getIntResponseCode() == 200)
                                                    {
                                                                    ...
                                                                    boolTestDataStatus = Chart_SendOrder.chart_SendOrder_Test(parameters, strResponse, mapPostDetails, softAssert, strCountQuery);
                                                    }
