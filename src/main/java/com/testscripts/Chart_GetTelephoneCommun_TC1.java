...
import com.endpoints.Chart_GetTelephoneCommun;
...
public class Chart_GetTelephoneCommun_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void chart_GetTelephoneCommun_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Chart_GetTelephoneCommun.chart_GetTelephoneCommun(parameters, strResponse, "id", softAssert);
					}
				}
