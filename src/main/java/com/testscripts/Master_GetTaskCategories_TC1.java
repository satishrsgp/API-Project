...
import com.endpoints.Master_GetTaskCategories;
...
public class Master_GetTaskCategories_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetTaskCategories_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetTaskCategories.master_GetTaskCategories_Test(parameters, strResponse, "id", softAssert);
				}
				else
