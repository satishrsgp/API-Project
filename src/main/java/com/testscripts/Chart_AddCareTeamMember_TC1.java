...
import com.endpoints.Chart_AddCareTeamMember;
...
public class Chart_AddCareTeamMember_TC1 extends BaseTest
{
    ...
    @Test
    public void chart_AddCareTeamMember_TC1()
    {
                    ...
                    try
                    {
                                    ...
                                    for(int k=1; k<=ExcelReaderWriter.getRowCount( BaseTest.mapExecutionConfigs.get("TestDataWorkBook"), strTestDataSheetName); k++)
                                    {
                                                    ...
                                                    String strCountQuery = "select * from patient_care_team_memb_ext_ WHERE person_id = '"+parameters.get("personId")+"' order by create_timestamp desc";
                                                    ...
                                                    if(Objects.equals(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass") && objHandler.getIntResponseCode() == 201)
                                                    {
                                                                    ...
                                                                    boolTestDataStatus = Chart_AddCareTeamMember.chart_AddCareTeamMember_Test(parameters, strResponse, mapPostDetails, softAssert, strCountQuery);
                                                    }
