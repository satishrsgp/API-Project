...
import com.endpoints.Master_GetVfcReasons;
...
public class Master_GetVfcReasons_TC1 extends BaseTest
{
	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_GetVfcReasons_TC1()
	{
		...
		try
		{
			...
			if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
			{
				...
				boolTestDataStatus = Master_GetVfcReasons.master_GetVfcReasons_Test(strResponse, "vfcCode", softAssert);
			}
			else
			{
