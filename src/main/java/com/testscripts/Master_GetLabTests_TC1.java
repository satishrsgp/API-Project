...
import com.endpoints.Master_GetLabTests;
...
public class Master_GetLabTests_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetLabTests_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetLabTests.master_GetLabTests_Test(parameters, strResponse, "id", softAssert);
				}
				else
