...
import com.endpoints.Master_GetRecallPlans;
...
public class Master_GetRecallPlans_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetRecallPlans_TC1()
	{
		...
		try
		{
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetRecallPlans.master_GetRecallPlans_Test(parameters, strResponse, "id", softAssert);
				}
				else
