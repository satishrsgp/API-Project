...
import com.endpoints.Master_GetImmunizationFundingSources;
...
public class Master_GetImmunizationFundingSources_TC1 extends BaseTest
{
	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_GetImmunizationFundingSources_TC1()
	{
		...
		try
		{
			...
			if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
			{
				...
				boolTestDataStatus = Master_GetImmunizationFundingSources.master_GetImmunizationFundingSources_Test(strResponse, "fundingSourceCode", softAssert);
			}
			else
			{
