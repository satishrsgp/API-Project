...
import com.endpoints.Master_GetSpecialtyLabTests;
...
public class Master_GetSpecialtyLabTests_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetSpecialtyLabTests_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetSpecialtyLabTests.master_GetSpecialtyLabTests_Test(parameters, strResponse, "id", softAssert);
				}
				else
