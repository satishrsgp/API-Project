...
import com.endpoints.GetPatientAllergyReactions;
...
public class GetPatientAllergyReactions_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void getPatientAllergyReactions_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = GetPatientAllergyReactions.getPatientAllergyReactions_Test(parameters, strResponse, "id", softAssert);
				}
				else
