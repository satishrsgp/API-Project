...
import com.endpoints.Provider_GetProviderEncounters;
...
public class Provider_GetProviderEncounters_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void provider_GetProviderEncounters_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Provider_GetProviderEncounters.provider_GetProviderEncounters(parameters, strResponse, "id", softAssert);
					}
				}
