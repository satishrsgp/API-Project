...
import com.endpoints.Provider_GetProviderErxDetails;
...
public class Provider_GetProviderErxDetails_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void provider_GetProviderErxDetails_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Provider_GetProviderErxDetails.provider_GetProviderErxDetails_Test(parameters, strResponse, "id", softAssert);
				}
				else
