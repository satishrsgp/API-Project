...
import com.endpoints.Chart_GetOrderInsurances;
...
public class Chart_GetOrderInsurances_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void chart_GetOrderInsurances_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetOrderInsurances.Chart_GetOrderInsurances_Test(parameters, strResponse, "id", softAssert);
				}
				else
