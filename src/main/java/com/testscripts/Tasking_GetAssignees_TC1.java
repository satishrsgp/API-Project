...
import com.endpoints.Tasking_GetAssignees;
...
public class Tasking_GetAssignees_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void tasking_GetAssignees_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Tasking_GetAssignees.tasking_GetAssignees_Test(parameters, strResponse, "userId", softAssert);
				}
				else
