...
import com.endpoints.Chart_AddDiagnosis;
...
public class Chart_AddDiagnosis_TC1 extends BaseTest
{
    ...
    @Test
    public void chart_AddDiagnosis_TC1()
    {
                    ...
                    try
                    {
                                    ...
                                    for(int k=1; k<=ExcelReaderWriter.getRowCount( BaseTest.mapExecutionConfigs.get("TestDataWorkBook"), strTestDataSheetName); k++)
                                    {
                                                    ...
                                                    String strCountQuery = "select  * from patient_diagnosis WHERE person_id = '"+parameters.get("personId")+"'  and enc_id ='"+parameters.get("encounterId")+"' order by create_timestamp desc";
                                                    ...
                                                    if(Objects.equals(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass") && objHandler.getIntResponseCode() == 201)
                                                    {
                                                                    ...
                                                                    boolTestDataStatus = Chart_AddDiagnosis.chart_AddDiagnosis_Test(parameters, strResponse, mapPostDetails, softAssert, strCountQuery);
                                                    }
