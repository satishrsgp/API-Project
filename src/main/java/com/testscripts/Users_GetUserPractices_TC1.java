...
import com.endpoints.Users_GetUserPractices;
...
public class Users_GetUserPractices_TC1 extends BaseTest
{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Users_GetUserPractices.users_GetUserPractices(parameters, strResponse, "id", softAssert);
					}
				}
