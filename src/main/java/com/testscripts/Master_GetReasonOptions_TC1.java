...
import com.endpoints.Master_GetReasonOptions;
...
public class Master_GetReasonOptions_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetReasonOptions_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetReasonOptions.master_GetReasonOptions_Test(parameters, strResponse, "id", softAssert);
				}
				else
