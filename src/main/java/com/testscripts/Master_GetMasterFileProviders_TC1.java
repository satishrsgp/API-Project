...
import com.endpoints.Master_GetMasterFileProviders;
...
//Defect-Api returns duplicate values
//Defect ID - NGAPI-460

public class Master_GetMasterFileProviders_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetMasterFileProviders_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetMasterFileProviders.master_GetMasterFileProviders_Test(parameters, strResponse, "id", softAssert);
				}
				else
