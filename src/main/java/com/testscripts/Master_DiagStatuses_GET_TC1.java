...
import com.endpoints.Master_DiagStatuses_GET;
...
public class Master_DiagStatuses_GET_TC1 extends BaseTest
{
	...
	public void master_AlertMessages_GET_TC1()
	{
		...
		try
		{
			...
			if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
			{
				...
				boolTestDataStatus = Master_DiagStatuses_GET.master_DiagStatuses_GET_Test(strResponse, "id", softAssert);
			}
			else
			{
