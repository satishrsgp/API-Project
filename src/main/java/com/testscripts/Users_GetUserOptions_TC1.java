...
import com.endpoints.Users_GetUserOptions;
...
public class Users_GetUserOptions_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void users_GetUserOptions_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Users_GetUserOptions.users_GetUserOptions(parameters, strResponse, "displayRenewals", softAssert);				
					}
				}
