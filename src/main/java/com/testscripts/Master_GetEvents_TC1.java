...
import com.endpoints.Master_GetEvents;
...
public class Master_GetEvents_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_GetEvents_TC1()
	{
		...
		try
		{
			...
			if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
			{
				...
				boolTestDataStatus = Master_GetEvents.master_GetEvents(strResponse, "id", softAssert);
			}
			else
			{
