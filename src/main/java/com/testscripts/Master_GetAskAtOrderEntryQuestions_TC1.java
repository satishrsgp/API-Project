...
import com.endpoints.Master_GetAskAtOrderEntryQuestions;
...
public class Master_GetAskAtOrderEntryQuestions_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetAskAtOrderEntryQuestions_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetAskAtOrderEntryQuestions.master_GetAskAtOrderEntryQuestions_Test(parameters, strResponse, "testId", softAssert);
				}
				else
