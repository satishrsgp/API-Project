...
import com.endpoints.Chart_GetPatientMedicationSummaries;
...
public class Chart_GetPatientMedicationSummaries_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void chart_GetPatientMedicationSummaries_TC1()
	{
			...
			if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPatientMedicationSummaries.chart_GetPatientMedicationSummaries_Test(parameters, strResponse, "id", softAssert);
				}
				else
				{
