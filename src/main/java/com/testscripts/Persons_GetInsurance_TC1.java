...
import com.endpoints.Persons_GetInsurance;
...
public class Persons_GetInsurance_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void persons_GetInsurance_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Persons_GetInsurance.persons_GetInsurance(parameters, strResponse, "payerId", softAssert);
