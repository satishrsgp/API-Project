...
import com.endpoints.GetProviderMedicationRefills;
...
public class GetProviderMedicationRefills_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void getProviderMedicationRefills_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = GetProviderMedicationRefills.getProviderMedicationRefills_Test(parameters, strResponse, "requestId", softAssert);
