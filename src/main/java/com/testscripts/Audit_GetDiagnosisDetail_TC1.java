...
import com.endpoints.Audit_GetDiagnosisDetail;
...
public class Audit_GetDiagnosisDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void audit_GetDiagnosisDetail_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus =  Audit_GetDiagnosisDetail.audit_GetDiagnosisDetail_Test(parameters, strResponse, "id", softAssert);					
					}
					else
					{
