...
import com.endpoints.Master_GetAllVaccines;
...
public class Master_GetAllVaccines_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void master_GetAllVaccines_TC1()
	{
		...
		try
		{
			...
			{	
				...
				mapRequestParrameters.put("strQueryString", "?cvxCode="+parameters.get("cvx_code"));
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Master_GetAllVaccines.master_GetAllVaccines_Test(parameters, strResponse, "cvxCode", softAssert);
				}
				else
