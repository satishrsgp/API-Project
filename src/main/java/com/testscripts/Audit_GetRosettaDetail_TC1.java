...
import com.endpoints.Audit_GetRosettaDetail;
...
public class Audit_GetRosettaDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void audit_GetRosettaDetail_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Audit_GetRosettaDetail.audit_GetRosettaDetail_Test(parameters, strResponse, "id", softAssert);
				}
				else
