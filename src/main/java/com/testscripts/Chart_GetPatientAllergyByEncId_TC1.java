...
import com.endpoints.Chart_GetPatientAllergyByEncId;
...
public class Chart_GetPatientAllergyByEncId_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetPatientAllergyByEncId_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPatientAllergyByEncId.chart_GetPatientAllergyByEncId_Test(parameters, strResponse, "id", softAssert);
				}
				else
