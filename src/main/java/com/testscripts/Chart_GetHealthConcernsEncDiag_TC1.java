...
import com.endpoints.Chart_GetHealthConcernsEncDiag;
...
public class Chart_GetHealthConcernsEncDiag_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void chart_GetHealthConcernsEncounterDiagnosis_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Chart_GetHealthConcernsEncDiag.chart_GetHealthConcernsEncounterDiagnosis(parameters, strResponse, "id", softAssert);
