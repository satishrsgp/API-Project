...
import com.endpoints.Audit_GetTemplateDetail;
...
public class Audit_GetTemplateDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void audit_GetTemplateDetail_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Audit_GetTemplateDetail.audit_GetTemplateDetail_Test(parameters, strResponse, "id", softAssert);
				}
				else
