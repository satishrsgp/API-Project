...
import com.endpoints.Chart_GetHealthConcernSocialHistory;
...
public class Chart_GetHealthConcernSocialHistory_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetHealthConcernSocialHistory_TC1()
	{
		...
		try
		{
			...
			{	
				...
				mapRequestParrameters.put("strQueryString","?$orderby=encounterTimestamp");
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetHealthConcernSocialHistory.Chart_GetHealthConcernSocialHistory_Test(parameters, strResponse, "exerciseType", softAssert);
				}
				else
