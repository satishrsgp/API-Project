...
import com.endpoints.Chart_GetGoalDetails;
...
public class Chart_GetGoalDetails_TC1 extends BaseTest 
{
	...
	@Test
	public void chart_GetGoalDetails_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetGoalDetails.Chart_GetGoalDetails_Test(parameters, strResponse, "goalId", softAssert);
				}
				else
