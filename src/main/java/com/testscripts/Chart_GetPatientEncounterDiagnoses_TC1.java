...
public class Chart_GetPatientEncounterDiagnoses_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void chart_GetPatientEncounterDiagnoses_TC1()
	{
		...
		try
		{
			...
			{	
				...
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Chart_GetPatientEncounterDiagnoses.chart_GetPatientEncounterDiagnoses_Test(parameters, strResponse, "id", softAssert);
				}
				else
