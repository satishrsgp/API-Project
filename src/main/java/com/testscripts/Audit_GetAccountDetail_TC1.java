...
import com.endpoints.Audit_GetAccountDetail;
...
public class Audit_GetAccountDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void audit_GetAccountDetail_TC1()
	{
		...
		try
		{
			...
			{	
				...
				{
					String strResponse = objHandler.getStrResponse().toString().replace("00000000-0000-0000-0000-000000000000", "");
					boolTestDataStatus = Audit_GetAccountDetail.audit_GetAccountDetail_Test(parameters, strResponse, "id", softAssert);
				}
				else
				{
