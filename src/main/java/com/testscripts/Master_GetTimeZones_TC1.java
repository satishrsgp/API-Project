...
import com.endpoints.Master_GetTimeZones;
...
public class Master_GetTimeZones_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void master_GetTimeZones_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Master_GetTimeZones.master_GetTimeZones(parameters, strResponse, "zoneName", softAssert);				
					}
				}
