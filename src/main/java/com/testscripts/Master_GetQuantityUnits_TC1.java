...
import com.endpoints.Master_GetQuantityUnits;
...
public class Master_GetQuantityUnits_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void users_GetUserPractices_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Master_GetQuantityUnits.master_GetQuantityUnits_Test(parameters, strResponse, "id", softAssert);
					}
				}
