...
import com.endpoints.Persons_GetGenderIdentities;
...
public class Persons_GetGenderIdentities_TC1  extends BaseTest{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void persons_GetGenderIdentities_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Persons_GetGenderIdentities.persons_GetGenderIdentities(parameters, strResponse, "personId", softAssert);
					}
				}
