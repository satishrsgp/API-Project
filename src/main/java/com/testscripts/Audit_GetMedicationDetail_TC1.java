...
import com.endpoints.Audit_GetMedicationDetail;
...
public class Audit_GetMedicationDetail_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void audit_GetMedicationDetail_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus =  Audit_GetMedicationDetail.audit_GetMedicationDetail_Test(parameters, strResponse, "id", softAssert);					
					}
				}
