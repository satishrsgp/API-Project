...
import com.endpoints.Chart_CancelMedication;
...
public class Chart_CancelMedication_TC1 extends BaseTest
{
    ...
    @Test
    public void chart_CancelMedication_TC1()
    {
                    ...
                    try
                    {
                                    ...
                                    for(int k=1; k<=ExcelReaderWriter.getRowCount( BaseTest.mapExecutionConfigs.get("TestDataWorkBook"), strTestDataSheetName); k++)
                                    {
                                                    ...
                                                    String strCountQuery = "select * from erx_message_history  "
                                							+ "where person_id='"+parameters.get("personId")+"' and "
                                							+"medication_id = '"+parameters.get("medicationId")+"'  "
                                                    ...
                                                    if(Objects.equals(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass") && objHandler.getIntResponseCode() == 200)
                                                    {
                                                                    ...
                                                                    boolTestDataStatus = Chart_CancelMedication.chart_CancelMedication_Test(parameters, strResponse, mapPostDetails, softAssert, strCountQuery);
                                                    }
