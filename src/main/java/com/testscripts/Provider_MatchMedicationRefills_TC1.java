...
import com.endpoints.Provider_MatchMedicationRefills;
...
public class Provider_MatchMedicationRefills_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void provider_MatchMedicationRefills_TC1()
	{
			...
			{	
				...
				Object[] testexecutionResult = hashMapResult.get(String.valueOf(k));
					...
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass") && objHandler.getIntResponseCode()==200)
					{
						...
						boolTestcaseStatus = Provider_MatchMedicationRefills.provider_MatchMedicationRefills_Test(parameters,  softAssert);
					}
