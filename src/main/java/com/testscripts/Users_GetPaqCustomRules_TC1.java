...
import com.endpoints.Users_GetPaqCustomRules;
...
public class Users_GetPaqCustomRules_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void users_GetPaqCustomRules_TC1()
	{
			...
			{	
				...
				if(!objHandler.getStrResponse().isEmpty())
				{
					if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
					{
						...
						boolTestcaseStatus = Users_GetPaqCustomRules.users_GetPaqCustomRules(parameters, strResponse, "id", softAssert);
					}
				}
