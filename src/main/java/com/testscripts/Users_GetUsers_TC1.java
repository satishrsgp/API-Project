...
import com.endpoints.Users_GetUsers;
...
public class Users_GetUsers_TC1 extends BaseTest
{

	SoftAssert softAssert = new SoftAssert();

	@Test
	public void users_GetUsers_TC1()
	{
		...
		try
		{
			...
			if(!objHandler.getStrResponse().isEmpty())
			{
				if(Objects.equal(testexecutionResult[testexecutionResult.length-1].toString().toLowerCase(), "pass"))
				{
					...
					boolTestDataStatus = Users_GetUsers.users_GetUsers_Test(parameters, strResponse, "id", softAssert);
				}
				else
				{
